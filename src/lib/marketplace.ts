...
export const TOOL_PROVIDERS: ToolProvider[] = [
  ...
  // --- Deployment ---
  {
    ...
    latencyMs: 15000,
    reliability: 0.99,
    walletAddress: "0xaB2c3D4e5F6A7890123456789ABCDEF01234567a",
    network: "base-sepolia",
    features: ["edge-network", "ssl", "custom-domains", "instant-rollback"],
    rateLimit: 20,
  },
  {
    id: "deploy-static",
    name: "Static Host",
    description: "Basic static file hosting. Fast and cheap.",
    category: "deployment",
    price: 0.06,
    qualityScore: 6,
    latencyMs: 5000,
    reliability: 0.95,
    walletAddress: "0xbC3d4E5f6A7B8901234567890ABCDEF012345678",
    network: "base-sepolia",
    features: ["static-only", "fast-deploy"],
    rateLimit: 50,
  },
  ...
  // --- Domain ---
  {
    id: "domain-lookup",
    name: "Domain Search",
    description: "Real-time domain availability check via RDAP. Searches across TLDs with pricing.",
    category: "domain",
    price: 0.05,
    qualityScore: 9,
    latencyMs: 2000,
    reliability: 0.97,
    walletAddress: "0xcD4e5F6a7B8C9012345678901ABCDEF0123456789",
    network: "base-sepolia",
    features: ["rdap", "multi-tld", "pricing", "real-time"],
    rateLimit: 60,
  },
  {
    id: "domain-crypto",
    name: "Unstoppable Domains",
    description: "Blockchain-native domains (.crypto, .x, .wallet). One-time purchase, no renewals.",
    category: "domain",
    price: 0.10,
    qualityScore: 8,
    latencyMs: 3000,
    reliability: 0.94,
    walletAddress: "0xdE5f6A7b8C9D0123456789012ABCDEF01234567ab",
    network: "base-sepolia",
    features: ["crypto-native", "no-renewal", "web3-identity"],
    rateLimit: 30,
  },
  {
    id: "domain-ens",
    name: "ENS Domains",
    description: "Ethereum Name Service (.eth). On-chain identity and DNS resolution.",
    category: "domain",
    price: 0.08,
    qualityScore: 9,
    latencyMs: 2500,
    reliability: 0.96,
    walletAddress: "0xeF6a7B8c9D0E1234567890123ABCDEF012345678c",
    network: "base-sepolia",
    features: ["ethereum-native", "on-chain", "reverse-resolution"],
    rateLimit: 40,
  },
];
